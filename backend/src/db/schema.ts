...
export const users = sqliteTable("users", {
  ...
  notifyEmailGdpr: integer("notify_email_gdpr").default(1),
  notifyEmailPictoNew: integer("notify_email_picto_new").default(1),
  notifyEmailPictoEnCours: integer("notify_email_picto_en_cours").default(1),
  notifyEmailPictoPrecision: integer("notify_email_picto_precision").default(1),
  notifyEmailPictoLivre: integer("notify_email_picto_livre").default(1),
  notifyEmailPictoRefuse: integer("notify_email_picto_refuse").default(1),
  notifyEmailNewsletter: integer("notify_email_newsletter").default(1),
  notifyEmailNewUser: integer("notify_email_new_user").default(1),
